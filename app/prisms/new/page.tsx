            ...
            {contacts.length > 0 && !contacts.some((c) => c.paymentDestinations.length > 0) && (
              <div className="bg-yellow-900/30 border border-yellow-800/50 rounded-lg p-4">
                <p className="text-yellow-300 text-sm">
                  Your contacts don&apos;t have payment destinations yet. <a href="/contacts" className="underline hover:text-yellow-200">Edit a contact</a> to add a payment destination (Offer, LNURL, or Lightning Address) first.
                </p>
              </div>
            )}
